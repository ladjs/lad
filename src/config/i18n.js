...
export default {
  ...
  INVALID_JOB_TITLE: 'Job title must be 4-40 characters.',
  INVALID_JOB_DESCRIPTION: 'Job description must be 100-300 characters.',
  ...
  JOB_POST_LIMIT: 'You have reached the limit for posting jobs. Please try again.',
