          ...
          <div class="navbar-expand">␊
            <ul class="navbar-nav">␊
              <li class="nav-item dropdown">␊
                <a class="btn btn-outline-secondary btn-sm dropdown-toggle" href="/en/terms" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="navbar-dropdown-language-btn">English </a>␊
          ...
          <div class="collapse navbar-collapse" id="navbar-header">␊
            <ul class="navbar-nav ml-auto">␊
              <li class="mt-3 nav-item ml-md-1 mt-md-0">␊
                <a class="btn d-block text-left text-md-center btn-outline-dark" href="/en/support">Support</a>␊
              </li>␊
    ...
    <![endif]-->␊
        <nav class="fixed-top bg-light border border-top-0 border-left-0 border-right-0 navbar navbar-expand-md navbar-light">␊
          ...
          <div class="navbar-expand">␊
            <ul class="navbar-nav">␊
              <li class="nav-item dropdown">␊
                <a class="btn btn-outline-secondary btn-sm dropdown-toggle" href="/en" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="navbar-dropdown-language-btn">English </a>␊
                <ul class="dropdown-menu" id="navbar-dropdown-language-ul" aria-labelledby="navbar-dropdown-language-btn">␊
                  <li>␊
        ...
        <div class="jumbotron rounded-0">␊
          <div class="container">␊
            ...
            <p>␊
              <a class="btn btn-success btn-lg" href="/register" role="button">Create an account »</a>␊
            </p>␊
          </div>␊
        </div>␊
        <div class="container">␊
...
> Snapshot 1
    ...
    <![endif]-->␊
        <nav class="fixed-top bg-light border border-top-0 border-left-0 border-right-0 navbar navbar-expand-md navbar-light">␊
          <button class="navbar-toggler bg-light hidden-lg-up" type="button" data-toggle="collapse" data-target="#navbar-header" aria-controls="navbar-header" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>␊
          <a class="navbar-brand h1 mb-0" href="/es">␊
            <img class="d-inline-block align-top" src="/img/logo-square.svg" width="30" height="30" alt=""> Lad</a>␊
          <div class="navbar-expand">␊
            <ul class="navbar-nav">␊
              <li class="nav-item dropdown">␊
                <a class="btn btn-outline-secondary btn-sm dropdown-toggle" href="/es/terms" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="navbar-dropdown-language-btn">Español </a>␊
                <ul class="dropdown-menu" id="navbar-dropdown-language-ul" aria-labelledby="navbar-dropdown-language-btn">␊
                  <li>␊
                    <a class="dropdown-item" href="/zh/terms">Chinese (Chinese)</a>␊
                  </li>␊
                  <li>␊
                    <a class="dropdown-item" href="/en/terms">English (English)</a>␊
                  </li>␊
                </ul>␊
              </li>␊
            </ul>␊
          ...
          <div class="collapse navbar-collapse" id="navbar-header">␊
            <ul class="navbar-nav ml-auto">␊
              <li class="mt-3 nav-item ml-md-1 mt-md-0">␊
                <a class="btn d-block text-left text-md-center btn-outline-dark" href="/es/support">Support</a>␊
              </li>␊
              <li class="nav-item ml-md-1 mt-1 mt-md-0">␊
                <a class="btn d-block text-left text-md-center btn-outline-success" href="/es/login">Sign in</a>␊
              </li>␊
            </ul>␊
          </div>␊
        </nav>␊
    ...
    <![endif]-->␊
        <nav class="fixed-top bg-light border border-top-0 border-left-0 border-right-0 navbar navbar-expand-md navbar-light">␊
          ...
          <div class="navbar-expand">␊
            <ul class="navbar-nav">␊
              <li class="nav-item dropdown">␊
                <a class="btn btn-outline-secondary btn-sm dropdown-toggle" href="/es" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="navbar-dropdown-language-btn">Español </a>␊
                <ul class="dropdown-menu" id="navbar-dropdown-language-ul" aria-labelledby="navbar-dropdown-language-btn">␊
                  <li>␊
                    <a class="dropdown-item" href="/zh/">Chinese (Chinese)</a>␊
                  </li>␊
                  <li>␊
                    <a class="dropdown-item" href="/en/">English (English)</a>␊
                  </li>␊
                </ul>␊
              </li>␊
            </ul>␊
